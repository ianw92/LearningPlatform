...
class WeeksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post weeks_url, params: { week: { lecture_module_id: @week.lecture_module_id, week_number: @week.week_number } }
    end
  ...
  test "should update week" do
    patch week_url(@week), params: { week: { lecture_module_id: @week.lecture_module_id, week_number: @week.week_number } }
